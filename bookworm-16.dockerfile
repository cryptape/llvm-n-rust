...
RUN curl -LO https://github.com/llvm/llvm-project/archive/llvmorg-18.1.8.tar.gz
...
# COPY llvmorg-18.1.8.tar.gz /tmp/llvm-project/llvmorg-18.1.8.tar.gz
RUN mkdir -p /llvm
RUN sha256sum llvmorg-18.1.8.tar.gz > /llvm/tarball_checksum.txt
RUN tar xzf llvmorg-18.1.8.tar.gz --strip-components=1 && rm llvmorg-18.1.8.tar.gz
